...
$check_for_username = mysql_query("SELECT id FROM jobberland_tempjs WHERE username='$username'");
...
$check_for_email = mysql_query("SELECT id FROM jobberland_tempjs WHERE email_address='$email'");
//Query to check if username is available or not 
